package al.ecommerce.shop.domain.category.service.impl;

import al.ecommerce.shop.domain.category.model.Category;
import al.ecommerce.shop.domain.category.repository.CategoryRepository;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public ResponseEntity<?> updateCategory(Category category, String id) {
        Category productUpdated = categoryRepository.findById(id).orElseThrow(EntityNotFoundException::new);
